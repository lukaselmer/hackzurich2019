...
import { Router as RouterOriginal, withRouter, RouteComponentProps } from 'react-router-dom';
...
type RouterContext = RouteComponentProps<any, StaticContext, any>;

const RouterContext = createContext<RouterContext>(undefined as any);
const RouterContextProvider = withRouter(props => {
